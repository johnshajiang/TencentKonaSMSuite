...
/**
 * The JMH-based performance test for the message digests.
 */
...
public class KonaMessageDigestPerfTest {
    ...
    public static class MessageDigestHolder {
        ...
        @Param({"KonaCrypto-Native", "KonaCrypto-NativeOneShot", "SUN"})
        String provider;
