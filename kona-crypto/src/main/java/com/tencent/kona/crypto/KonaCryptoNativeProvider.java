...
public class KonaCryptoNativeProvider extends Provider {
    ...
    private static void putECDSAEntries(Provider provider) {
        ...
        provider.put("Signature.SHA224withECDSA",
                "com.tencent.kona.crypto.provider.nativeImpl.KonaECDSASignature$SHA224");
        ...
        provider.put("Signature.SHA256withECDSA",
                "com.tencent.kona.crypto.provider.nativeImpl.KonaECDSASignature$SHA256");
        ...
        provider.put("Signature.SHA384withECDSA",
                "com.tencent.kona.crypto.provider.nativeImpl.KonaECDSASignature$SHA384");
        ...
        provider.put("Signature.SHA512withECDSA",
                "com.tencent.kona.crypto.provider.nativeImpl.KonaECDSASignature$SHA512");
